...
TABS_METADATA = {
    ...
    "PARTNERS":['Name of the Partner','Logo of the partner','State in which  the partner is present', 'Type of the Partner','Website', 'Headoffice address', 'lattitude','longitude'],
